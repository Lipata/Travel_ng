...
describe('InAppComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [InAppComponent, NoopAnimationsModule, FormsModule, ReactiveFormsModule, RouterTestingModule, IgxIconButtonDirective, IgxRippleDirective, IgxIconComponent, IgxAvatarComponent, IGX_NAVIGATION_DRAWER_DIRECTIVES]
    })
    .compileComponents();
